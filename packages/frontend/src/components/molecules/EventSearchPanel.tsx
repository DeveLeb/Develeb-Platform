// src/components/molecules/EventSearchPanel.tsx
  ...
  return (
    <div className="w-[2000px] h-[385px] bg-gray-300 p-10 shadow-lg flex justify-center">
      <div className="max-w-[1400px] w-full flex flex-col justify-center">
        <h1 className="text-[40px] font-bold text-white mb-3 text-left">
        ...
        <div className="flex items-end">
          ...
          <Button
            onClick={onSearch}
            className="h-[60px] bg-gray-800 hover:bg-gray-600 text-white font-bold mb-4"
          >
            Search Event
          </Button>
        </div>
